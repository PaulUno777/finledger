...
| FL-190 | Finalize CTO integration runbook | `feature/FL-190-cto-integration-guide` | done |
...
copy-paste [INTEGRATION_GUIDE.md](INTEGRATION_GUIDE.md) CTO / production runbook
(K8s go-live, Hub + external IdP). Ops model: [ADR-015](adr/ADR-015-operational-model.md).
